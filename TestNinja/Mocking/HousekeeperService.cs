...
namespace TestNinja.Mocking
{
    public class HousekeeperService
    {
        ...
        public HousekeeperService(IUnitOfWork unitOfWork, IEmailSender emailSender, 
            IStatementGenerator statementRepository, IXtraMessageBox xtraMessageBox)
        {
            this._unitOfWork = unitOfWork;
            this._emailSender = emailSender;
            this._statementGenerator = statementRepository;
